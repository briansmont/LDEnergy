  ...
  render: function() {
    return (
      <div className="childwidth">
        <p className="text-center page-title">Data below is current and sourced from the <a href="https://www.eia.gov/" target="_blank">U.S. Energy Info Administration</a></p>
